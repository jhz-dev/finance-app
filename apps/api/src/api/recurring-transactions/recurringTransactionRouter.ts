...
import { createRecurringTransaction, getRecurringTransactions, updateRecurringTransaction, deleteRecurringTransaction } from './recurringTransactionController';

const router = Router();

router.use(protect);

router.route('/budgets/:budgetId/recurring-transactions')
